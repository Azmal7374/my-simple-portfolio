...
const Footer = () => {
    return (
        ...
        <div>
          ...
          <Link to="/summary" className="link link-hover">Summary</Link> 
          <Link className="link link-hover">Hire Me</Link>
        </div> 
        <div>
      ...
      <img className="w-10 bg-white "  src={logo} alt="" / >
        <p className=' '>Copyright © 2023 <span className="text-orange-500">FolioMine</span> - All right reserved</p>
      </div> 
