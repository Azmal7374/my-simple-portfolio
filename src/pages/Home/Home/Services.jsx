...
const Services = () => {
    return (
        ...
        <div className="flex gap-4 items-center bg-[#373a3d] p-4 md:p-8 rounded-md shadow-2xl"
        data-aos="fade-down">
          ...
          <div className="">
          <h2 className=" text-2xl md:text-3xl text-white font-bold">ReactJs Developer</h2>
          <p className="mt-4">The React. js framework is an open-source JavaScript framework and library developed by Facebook.  </p>
          </div>
        </div>

        <div className="flex gap-4 items-center bg-[#373a3d] p-4 md:p-8 rounded-md shadow-2xl" data-aos="fade-up">
        <div className="icon border border-[#373a3d] p-2 h-20 w-28 flex justify-center  items-center bg-[#373a3d]">
        <MdNetworkWifi1Bar className="text-5xl text-orange-500"></MdNetworkWifi1Bar>
        </div>
        <div className="">
        <h2 className="text-2xl md:text-3xl text-white font-bold">Advance Networking</h2>
      ...
      <div className="flex gap-4 items-center bg-[#373a3d] p-4 md:p-8 rounded-md shadow-2xl" data-aos="fade-down">
      <div className="icon border border-[#373a3d] p-2 h-20 w-28 flex justify-center  items-center bg-[#373a3d]">
      <AiFillHtml5 className="text-5xl text-orange-500"></AiFillHtml5>
      </div>
      <div className="">
      <h2 className="text-2xl md:text-3xl text-white font-bold">Html Developer</h2>
    ...
    <div className="">
    <h2 className="text-2xl md:text-3xl text-white font-bold">Javscript Developer</h2>
  ...
  <div className="">
  <h2 className="text-2xl md:text-3xl text-white font-bold">Natural Language Processing</h2>
  <p className="mt-4">The React. js framework is an open-source JavaScript framework and library developed by Facebook.  </p>
  </div>
</div>
...
<div className="">
<h2 className="text-2xl md:text-3xl text-white font-bold">NodeJs Developer</h2>
